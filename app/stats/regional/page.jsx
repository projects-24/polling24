...
export default function Regional() {
    const data =
    {
        ...
        "titles": ["Serial", "Region", "Code", "Rejected", "Invalid", "Status", "NDC", "NPP", "APC", "CPP", "PNC", "LPG", "NDP"],
        "fields": ["seriel_no", "region", "regional_code", "rejected", "invalid", ]
    }
  ...
  return (
    <div>
        <NavBar />
        <Content>
        <Header title={'Regional Statistics'} subtitle={"Check all regional statistics"}/>
